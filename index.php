<html lang="en">
	...
	<?php if (!isset($_REQUEST["sistemaExterno"]) || !isset($_REQUEST["sistema"])) {?>
		...
		<script type="text/javascript" src="/indice_paciente_2017/assets/js/main.js?v=0.0.15"></script>
	...
	<?php }?>
		<script type="text/javascript" src="/indice_paciente_2017/controllers/client/index/index.js?v=<?=round(microtime(true) * 1000);?>"></script>
	</head>
	<br>
