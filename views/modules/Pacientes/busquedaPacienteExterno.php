	...
	if($_POST['back']==1){		
		...
		if($_POST){
	    	...
	    	$fonasa             = $_GET['fonasa'];  		
	  		...
	  		$calcularEdad       = $_GET['calcularEdad'];
	  		$sexo               = $_GET['sexo'];
	  		$etnia              = $_GET['etnia'];
	  		$ctp                = $_GET['ctp'];
	  		$nac                = $_GET['nac'];
	  		...
	  		$pacienteFall       = $_GET['pacienteFall'];	
	  		$tipoDocumento      = $_GET['tipoDocumentoLabel'];	//add - 11-12-2017
			$doc_documento      = $_GET['doc_documento'];	//add - 11-12-2017
			$paisNacimiento     = $_GET['paisNacimiento'];
			$PACafro            = $_GET['PACafro'];
			$region             = $_GET['region'];
			$ciudad             = $_GET['ciudad'];
			$calle              = $_GET['calle'];
			$numero             = $_GET['numero'];
