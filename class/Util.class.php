<?php class Util{
	...
	// function horas_fechas($fecha1,$fecha2){ 
	// 	$temp1=strtotime($fecha1); //segs desde fecha unix
	// 	$temp2=strtotime($fecha2); //segs desde la fecha unix
	...
	function DiferenciaHoras($fechaIncio, $fechaFin){
		date_default_timezone_set("America/Argentina/Buenos_Aires");
		$fecha  = strtotime($fechaIncio); //Convierte la fecha a unix
		$fecha2 = strtotime($fechaFin); //Convierte la fecha2 a unix
		...
		$Diferencia = floor($fecha2/$hora) - floor($fecha/$hora);
		return $Diferencia;
	}
}?>